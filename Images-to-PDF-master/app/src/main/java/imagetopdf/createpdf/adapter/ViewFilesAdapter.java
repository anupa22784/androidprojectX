package imagetopdf.createpdf.adapter;
...
import imagetopdf.createpdf.R;
import imagetopdf.createpdf.fragment.ViewFilesFragment;
...
public class ViewFilesAdapter extends RecyclerView.Adapter<ViewFilesAdapter.ViewFilesHolder> {
    ...
    private void shareFile(String name) {
        Uri uri = FileProvider.getUriForFile(mContext, "com.imagetopdf.shareFile", new File(name));
